package io.playground.userservice.common.exception;
...
public enum CustomErrorCode {
    ...
    // 400
    USER_ALREADY_EXISTS("User-101", "해당 이메일로 가입된 유저가 이미 존재합니다.", HttpStatus.BAD_REQUEST),

    // 404
    USER_NOT_FOUND("User-201", "해당하는 유저를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
